...
//     // שליפת נתונים מהמסד (המשימה שלך)
//     useEffect(() => {
//         const fetchSchedule = async () => {
//             if (open && roomId) {
//                 try {
//                     const response = await axios.get(`http://localhost:3000/api/classroom/${roomId}/allocations`);
...
//     const getPermanentCellData = (dayIndex, hour) => {
//         const found = allAllocations.find(a => a.dayOfWeek === dayIndex && a.startTime === hour && a.isPermanent);
...
//     return (
//         <>
//             {/* חלון 1: המערכת השבועית הראשית (עם כל הכפתורים) */}
//             <Dialog
//                 open={open}
//                 onClose={onClose}
//                 TransitionComponent={Transition}
...
//                                         <TableCell align="center" sx={{ fontWeight: 'bold', bgcolor: '#fcfcfc' }}>{hour}</TableCell>
//                                         {days.map((_, dayIndex) => (
//                                             <TableCell key={dayIndex} align="center" sx={{ height: '55px' }}>
...
//             >
//                 <Box sx={{ p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
//                     <Typography variant="h6" fontWeight="700">מערכת לתאריך: {selectedDate}</Typography>
//                     <IconButton onClick={() => setIsDailyOpen(false)}><CloseIcon /></IconButton>
//                 </Box>
//                 <Divider />
//                 <DialogContent>
//                     <Box sx={{ minHeight: '150px', py: 2 }}>
//                         {/* כאן יוצגו השיבוצים (זמניים + קבועים) לאותו יום ספציפי מה-allAllocations */}
//                         <Typography variant="body2" color="text.secondary" textAlign="center">
//                             מציג נתונים מהמסד לתאריך זה...
//                         </Typography>
//                     </Box>

//                     {/* הכפתור הספציפי שצריך להופיע רק כאן */}
//                     <Button
//                         fullWidth
//                         variant="contained"
//                         color="secondary"
